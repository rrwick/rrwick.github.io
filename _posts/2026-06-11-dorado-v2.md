...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20659712.svg)](https://doi.org/10.5281/zenodo.20659712)
...
That's a big claim! In [previous releases](https://rrwick.github.io/2025/05/27/dorado-v1.html), sup has been much better than hac, both for read-level and assembly-level accuracy. So I was sceptical that this new hac model could really be as good as ONT claimed. This blog post aims to test that.
...
**19 June 2026 update:** Mike Vella from ONT provided me with a potential explanation for these errors: phosphorothioate modifications. See more in the [next post](https://rrwick.github.io/2026/06/19/dorado-v2-polishing.html).

**9 July 2026 update:** I think the mystery is now solved: 7-deazaguanine modifications from the _dpd_ system are causing the higher error rate in this _Klebsiella_ genome. Thanks to Michael Biggel (University of Zurich) for figuring this one out and letting me know. Here's a link to his preprint which covers this: [Standalone nanopore sequencing for foodborne pathogen surveillance: a large-scale evaluation and quality control framework](https://www.biorxiv.org/content/10.64898/2026.03.20.713089v2).
